...
function genCSSMotion(config) {
  ...
  const CSSMotion = /*#__PURE__*/React.forwardRef((props, ref) => {
    ...
    if (isRefNotConsumed(children) && (0, _ref.supportNodeRef)(returnNode)) {
      const originNodeRef = (0, _ref.getNodeRef)(returnNode);
      if (originNodeRef !== nodeRef) {
        return /*#__PURE__*/React.cloneElement(returnNode, {
          ref: (0, _ref.composeRef)(originNodeRef, nodeRef)
        });
      }
    }
    return returnNode;
