...
var Input = /*#__PURE__*/React.forwardRef(function (props, ref) {
   ...
   */
  var triggerInputChange = (0, _util.useEvent)(function (text) {
  ...
  var onFormatKeyDown = function onFormatKeyDown(event) {
    ...
    var offsetCellValue = function offsetCellValue(offset) {
      var _getMaskRange = (0, _util2.getMaskRange)(cellFormat),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: holderRef,
    className: (0, _clsx2.clsx)(inputPrefixCls, _defineProperty(_defineProperty({}, "".concat(inputPrefixCls, "-active"), active && showActiveCls), "".concat(inputPrefixCls, "-placeholder"), helped), className)
