...
} & Pick<import("./interface").BaseInputProps, "suffix" | "allowClear"> & Pick<import("./interface").InputProps, "showCount" | "count" | "onClear"> & React.RefAttributes<ResizableTextAreaRef>>;
