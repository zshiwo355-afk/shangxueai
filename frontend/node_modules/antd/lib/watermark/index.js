...
const Watermark = props => {
  ...
  (0, _react.useEffect)(syncWatermark, [rotate, mergedZIndex, width, height, image, content, color, fontSize, fontWeight, fontStyle, fontFamily, textAlign, gapX, gapY, offsetLeft, offsetTop]);
  // ============================ Context =============================
