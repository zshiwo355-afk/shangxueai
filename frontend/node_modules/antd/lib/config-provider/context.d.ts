...
export type InputPasswordConfig = ComponentStyleConfig & Pick<PasswordProps, 'classNames' | 'styles' | 'iconRender'>;
export type InputSearchConfig = ComponentStyleConfig & Pick<SearchProps, 'classNames' | 'styles' | 'searchIcon'>;
...
export type FormConfig = ComponentStyleConfig & Pick<FormProps, 'requiredMark' | 'colon' | 'scrollToFirstError' | 'validateMessages' | 'variant' | 'classNames' | 'styles' | 'tooltip' | 'labelAlign'>;
