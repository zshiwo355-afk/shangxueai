...
class User(Base):
    ...
    job_level: Mapped[str] = mapped_column(String(16), default="M线")
    rank_name: Mapped[str] = mapped_column(String(32), default="")
...
class MagicVideo(Base):
    ...
    cover_asset_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True, index=True)
...
class MagicAudioUpload(Base):
    ...
    file_size: Mapped[int] = mapped_column(BigInteger, default=0)
    mime_type: Mapped[str] = mapped_column(String(128), default="")
    image_object_key: Mapped[str] = mapped_column(String(512), default="")
    image_url: Mapped[str] = mapped_column(String(1024), default="")
    image_file_name: Mapped[str] = mapped_column(String(255), default="")
    image_mime_type: Mapped[str] = mapped_column(String(128), default="")
    image_size: Mapped[int] = mapped_column(BigInteger, default=0)
    audio_object_key: Mapped[str] = mapped_column(String(512), default="")
    ...
    transcript_status: Mapped[str] = mapped_column(String(16), default="")
    transcript_error: Mapped[str] = mapped_column(String(512), default="")
...
class QuestionBank(Base):
    ...
    ai_grading_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    grading_keywords: Mapped[str | None] = mapped_column(Text, nullable=True)
    status: Mapped[str] = mapped_column(String(16), default="active")
    source: Mapped[str] = mapped_column(String(32), default="manual")
...
class Paper(Base):
    ...
    manual_review_subjective: Mapped[bool] = mapped_column(Boolean, default=False)
...
class PaperAssignment(Base):
    ...
    paper_id: Mapped[int] = mapped_column(BigInteger, nullable=False)
    user_id: Mapped[int] = mapped_column(BigInteger, nullable=False)
    reviewer_id: Mapped[int | None] = mapped_column(BigInteger, nullable=True, index=True)
    reward_points: Mapped[int | None] = mapped_column(Integer, nullable=True)
